...
; Section Header
;
    db ".data", 0, 0, 0        ; Section Name
    dd 0                       ; VirtualSize
    dd round(hdrsize, sectionalign) + round(codesize, 4) ; VirtualAddress
    dd 0                       ; SizeOfRawData
    ...
    db ".rsrc", 0, 0, 0        ; Section Name
    dd 0                       ; VirtualSize
    dd round(hdrsize, sectionalign) + round(codesize, 4) + 0 ; VirtualAddress
    dd 0                       ; SizeOfRawData
    dd 0                       ; PointerToRawData
    dd 0                       ; PointerToRelocations
    dd 0                       ; PointerToLinenumbers
